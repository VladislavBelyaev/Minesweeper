...
import Minesweeper.util.CoordinateUtils;
...
public class TextGame implements GameViewController
{
    ...
    {
        println(getTimeString(timer.getSeconds() / 3600) + ":" + getTimeString((timer.getSeconds() % 3600) / 60) + ":" + getTimeString(timer.getSeconds() % 60));
    ...
    public void noticeWinGame()
    {
        ...
        Pair pair = new Pair(name + ";" + getTimeString(timer.getSeconds() / 3600) + ":" +
